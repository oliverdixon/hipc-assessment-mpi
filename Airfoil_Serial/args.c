...
static struct option long_options[] = {{"airfoil", required_argument, 0, 'a'}, {"del-t", required_argument, 0, 'd'},
        ...
        {"endtime", required_argument, 0, 't'}, {"noio", no_argument, 0, 'd'}, {"output", required_argument, 0, 'o'},
        {"checkpoint", no_argument, 0, 'c'}, {"verbose", no_argument, 0, 'v'}, {"help", no_argument, 0, 'h'},
        {0, 0, 0, 0}};
